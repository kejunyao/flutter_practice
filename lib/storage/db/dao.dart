...
abstract class Dao<T> {
  ...
  Future<bool> has({@required String whereClause, List<dynamic> whereArgs});

  /// 查询符合条件的某条记录
  /// [whereClause] 查询条件
  /// [whereArgs] 查询条件中的参数
  /// return 实体类
  Future<T> query({@required String whereClause, List<dynamic> whereArgs});

  /// 查询符合条件的多条记录
  /// [whereClause] 查询条件
  /// [whereArgs] 查询条件中的参数
  /// return 符合条件的多条记录
  Future<List<T>> queryMany({@required String whereClause, List<dynamic> whereArgs});
