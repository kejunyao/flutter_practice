...
/// or pop-up menu. In that case, you might pair the [CompatibleSingleChildScrollView]
/// with a [ListBody] child.
///
/// When you have a list of children and do not require cross-axis
/// shrink-wrapping behavior, for example a scrolling list that is always the
/// width of the screen, consider [ListView], which is vastly more efficient
/// that a [CompatibleSingleChildScrollView] containing a [ListBody] or [Column] with
/// many children.
///
/// ## Sample code: Using [CompatibleSingleChildScrollView] with a [Column]
///
...
/// make sense to wrap the layout in a [CompatibleSingleChildScrollView].
///
/// Simply doing so, however, usually results in a conflict between the [Column],
/// which typically tries to grow as big as it can, and the [CompatibleSingleChildScrollView],
...
/// content beyond the dimensions of the screen, then [CompatibleSingleChildScrollView]
...
/// the constraints that the [CompatibleSingleChildScrollView] sees, since viewports
...
class CompatibleSingleChildScrollView extends StatelessWidget {
  /// Creates a box in which a single widget can be scrolled.
  const CompatibleSingleChildScrollView({
    Key key,
